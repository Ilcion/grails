...
<g:if test="${questionInstance.image}">
	<div class="form-group">
		<label for="image" class="col-sm-2 control-label">Aktualny obrazek:</label>
		<div class="col-sm-10"> 
...
<div class="form-group ${hasErrors(bean: questionInstance, field: 'Obrazek', 'error')}">
	<label for="image" class="col-sm-2 control-label"><g:message code="question.image.label" default="Obrazek" /></label>
	 <div class="col-sm-10"> 
		<input type="file" class="form-control" style="padding:0px;" id="image" name="image" />
		<p class="help-block text-left">UWAGA: Aby skasować aktualny obrazek wystarczy pole "Obrazek" pozostawiń puste! Maksymalna wielkość: 2MB</p>
	</div>	
</div>

<div class="form-group ${hasErrors(bean: questionInstance, field: 'Tresc pytania', 'error')} required">
	<label for="content" class="col-sm-2 control-label"> <g:message code="question.content.label" default="Treść pytania:" /><span class="required-indicator">*</span></label>
	<div  class="col-sm-10">
		<g:textArea class="form-control" name="content" required="" value="${questionInstance?.content}" />
	</div>
</div>
