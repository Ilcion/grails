				...
				<div class="inner cover">
					...
					<g:form class="form-horizontal">
						...
						<g:if test="${questionInstance?.imageType}">
							<div class="form-group">
								<label class="col-sm-2 control-label"><g:message
										code="question.imageType.label" default="Format obrazka:" /></label>
								<div class="col-sm-10 text-left" style="padding-top: 7px;">
									<g:fieldValue bean="${questionInstance}" field="imageType"
										class="form-control" />
								</div>
							</div>
						</g:if>
						...
						<g:if test="${questionInstance?.content}">
							<div class="form-group">
								<label class="col-sm-2 control-label"><g:message
										code="question.imageType.label" default="Pytanie:" /></label>
								<div class="col-sm-10 text-left" style="padding-top: 7px;">
