...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'answer.label', default: 'Odpowiedzi')}" />
		...
		<div class="site-wrapper">
			...
			<g:form url="[resource:answerInstance, action:'update']" method="PUT" >
				...
				<fieldset class="buttons">
					<g:actionSubmit class="btn btn-primary" action="update" value="${message(code: 'default.button.update.label', default: 'Edytuj')}" />
				</fieldset>
			</g:form>
		</div>
		</div>
